        ...
        onEntered: {
            if (root.isVerticalOrientation && root.selectedMount) {
                ...
                if (tooltipLoader.item) {
                    ...
                    const tooltipX = root.axis?.edge === "left" ? (Theme.barHeight + SettingsData.ShellitBarSpacing + Theme.spacingXS) : (currentScreen.width - Theme.barHeight - SettingsData.ShellitBarSpacing - Theme.spacingXS)
