...
Item {
                                       ...
                                       if (mouse.button === Qt.LeftButton) {
                                           ...
                                           if (windowContextMenuLoader.item) {
                                               ...
                                               if (root.isVertical) {
                                                   ...
                                                   const xPos = root.axis?.edge === "left" ? (Theme.barHeight + SettingsData.ShellitBarSpacing + Theme.spacingXS) : (root.parentScreen.width - Theme.barHeight - SettingsData.ShellitBarSpacing - Theme.spacingXS)
                                                   ...
                                                   const yPos = Theme.barHeight + SettingsData.ShellitBarSpacing - 7
                        ...
                        onEntered: {
                            ...
                            if (tooltipLoader.item) {
                                if (root.isVertical) {
                                    ...
                                    const screenY = root.parentScreen ? root.parentScreen.y : 0
                                    const relativeY = globalPos.y - screenY
                                    const tooltipX = root.axis?.edge === "left" ? (Theme.barHeight + SettingsData.ShellitBarSpacing + Theme.spacingXS) : (root.parentScreen.width - Theme.barHeight - SettingsData.ShellitBarSpacing - Theme.spacingXS)
                                    ...
                                    const tooltipY = Theme.barHeight + SettingsData.ShellitBarSpacing + Theme.spacingXS
    ...
    Loader {
        ...
        sourceComponent: ShellitTooltip {}
    }
