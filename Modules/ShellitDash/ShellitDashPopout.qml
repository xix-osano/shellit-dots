...
ShellitPopout {
    ...
    function setTriggerPosition(x, y, width, section, screen) {
        ...
        if (section === "center" && (SettingsData.ShellitBarPosition === SettingsData.Position.Top || SettingsData.ShellitBarPosition === SettingsData.Position.Bottom)) {
            const screenWidth = screen ? screen.width : Screen.width
            triggerX = (screenWidth - popupWidth) / 2
            triggerWidth = popupWidth
        } else if (section === "center" && (SettingsData.ShellitBarPosition === SettingsData.Position.Left || SettingsData.ShellitBarPosition === SettingsData.Position.Right)) {
    ...
    triggerY: Math.max(26 + SettingsData.ShellitBarInnerPadding + 4, Theme.barHeight - 4 - (8 - SettingsData.ShellitBarInnerPadding)) + SettingsData.ShellitBarSpacing + SettingsData.ShellitBarBottomGap - 2
    triggerWidth: 80
