        ...
        ColumnLayout {
            ...
            Repeater {
                ...
                delegate: Item {
                    ...
                    Timer {
                        id: actionTimer
                        interval: ShellitAppearance.animation.elementMoveFast.duration
                        repeat: false
                        onTriggered: {
                    ...
                    Rectangle {
                        ...
                        color: ShellitAppearance.colors.colLayer2
                        radius: ShellitAppearance.rounding.small
                        ColumnLayout {
                            ...
                            RowLayout {
                                ...
                                TodoItemActionButton {
                                    ...
                                    contentItem: MaterialSymbol {
                                        ...
                                        iconSize: ShellitAppearance.font.pixelSize.larger
    ...
    Item { // Placeholder when list is empty
        ...
        ColumnLayout {
            ...
            MaterialSymbol {
                ...
                iconSize: 55
                color: ShellitAppearance.m3colors.m3outline
                text: emptyPlaceholderIcon
            }
            StyledText {
                Layout.alignment: Qt.AlignHCenter
                font.pixelSize: ShellitAppearance.font.pixelSize.normal
                color: ShellitAppearance.m3colors.m3outline
                horizontalAlignment: Text.AlignHCenter
