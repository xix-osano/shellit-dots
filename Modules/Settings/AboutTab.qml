            ...
            StyledRect {
                ...
                Column {
                    ...
                    Grid {
                        ...
                        StyledText {
                            text: `<a href="https://Shellitlinux.com" style="text-decoration:none; color:${Theme.primary};">Shellitlinux.com</a>`
                            linkColor: Theme.primary
                            textFormat: Text.RichText
                            onLinkActivated: url => Qt.openUrlExternally(url)
                            font.pixelSize: Theme.fontSizeMedium
                        ...
                        StyledText {
                            text: `<a href="https://plugins.Shellitlinux.com" style="text-decoration:none; color:${Theme.primary};">plugins.Shellitlinux.com</a>`
                            linkColor: Theme.primary
                            textFormat: Text.RichText
                            onLinkActivated: url => Qt.openUrlExternally(url)
                            font.pixelSize: Theme.fontSizeMedium
            ...
            StyledRect {
                ...
                Row {
                    ...
                    ShellitButton {
                        ...
                        anchors.verticalCenter: parent.verticalCenter
                        onClicked: Qt.openUrlExternally("https://ko-fi.com/Shellitlinux")
                    }
                }
            }
