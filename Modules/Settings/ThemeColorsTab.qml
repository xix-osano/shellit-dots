                ...
                Column {
                    ...
                    Column {
                        ...
                        ShellitSlider {
                            ...
                            height: 24
                            value: Math.round(
                                       SettingsData.ShellitBarTransparency * 100)
                            minimum: 0
                            maximum: 100
                            unit: ""
                            showValue: true
                            ...
                            onSliderValueChanged: newValue => {
                                                      SettingsData.setShellitBarTransparency(
                                                          newValue / 100)
                                                  }
                        }
                    }
                    ...
                    Column {
                        ...
                        ShellitSlider {
                            ...
                            height: 24
                            value: Math.round(
                                       SettingsData.ShellitBarWidgetTransparency * 100)
                            minimum: 0
                            maximum: 100
                            unit: ""
                            showValue: true
                            ...
                            thumbOutlineColor: Theme.surfaceContainerHigh
                            onSliderValueChanged: newValue => {
                                                      SettingsData.setShellitBarWidgetTransparency(
                                                          newValue / 100)
                                                  }
                        }
                    }
