...
Item {
    ...
    Canvas {
        ...
        Connections {
            target: SettingsData
            function onShellitBarBorderColorChanged() { root.requestRepaint() }
            function onShellitBarBorderOpacityChanged() { root.requestRepaint() }
            function onShellitBarBorderThicknessChanged() { root.requestRepaint() }
            function onShellitBarSpacingChanged() { root.requestRepaint() }
            function onShellitBarSquareCornersChanged() { root.requestRepaint() }
            function onShellitBarTransparencyChanged() { root.requestRepaint() }
        }
