...
RippleButton {
    ...
    colBackground: ShellitAppearance?.colors.colPrimaryContainer
    colBackgroundHover: ShellitAppearance?.colors.colPrimaryContainerHover
    colRipple: ShellitAppearance?.colors.colPrimaryContainerActive
    contentItem: RowLayout {
        ...
        MaterialSymbol {
            ...
            iconSize: 24
            color: ShellitAppearance?.colors.colOnPrimaryContainer
            text: root.iconText
        }
        Loader {
            active: true
