...
TabButton {
    ...
    property color colBackground: ColorUtils.transparentize(ShellitAppearance.colors.colLayer1Hover, 1)
    ...
    background: Rectangle {
        id: buttonBackground
        radius: ShellitAppearance?.rounding.small ?? 7
        implicitHeight: 37
        ...
        RowLayout {
            ...
            Component {
                ...
                MaterialSymbol {
                    ...
                    fill: selected ? 1 : 0
                    color: selected ? ShellitAppearance.colors.colPrimary : ShellitAppearance.colors.colOnLayer1
                    Behavior on color {
                        animation: ShellitAppearance.animation.elementMoveFast.colorAnimation.createObject(this)
                    }
                }
            ...
            StyledText {
                id: buttonTextWidget
                verticalAlignment: Text.AlignVCenter
                font.pixelSize: ShellitAppearance.font.pixelSize.small
                color: selected ? ShellitAppearance.colors.colPrimary : ShellitAppearance.colors.colOnLayer1
                text: buttonText
                Behavior on color {
                    animation: ShellitAppearance.animation.elementMoveFast.colorAnimation.createObject(this)
