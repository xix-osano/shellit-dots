...
ApplicationWindow {
    ...
    visible: true
    onClosing: Qt.quit()
    title: "shellos-shellit Settings"
            ...
            Item {
                ...
                NavigationRail { // Window content with navigation rail and content pane
                    ...
                    FloatingActionButton {
                        ...
                        downAction: () => {
                            Qt.openUrlExternally(`${Directories.config}/shellos-shellit/config.json`);
                        }
                        altAction: () => {
                            Quickshell.clipboardText = CF.FileUtils.trimFileProtocol(`${Directories.config}/shellos-shellit/config.json`);
                            fab.justCopied = true;
