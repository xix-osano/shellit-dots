...
QUICKSHELL_CONFIG_NAME="quickshell-ss"
...
shellosShellitConfigPath="$HOME/.config/shellos-shellit/config.json"
currentWallpaperPath=$(jq -r '.background.wallpaperPath' $shellosShellitConfigPath)
